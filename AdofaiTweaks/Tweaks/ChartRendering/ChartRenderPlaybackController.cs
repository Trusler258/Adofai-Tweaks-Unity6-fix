...
namespace AdofaiTweaks.Tweaks.ChartRendering
{
    internal sealed class ChartRenderPlaybackController
    {
        ...
        public ChartRenderPlaybackController(ChartRenderingSettings settings)
        {
        ...
        public void RestoreState()
        {
            ...
            try
            {
                // SwitchToEditMode handles everything: scene reset, floor select, UI restore
                ADOBase.editor?.SwitchToEditMode(true);
            }
            catch (Exception ex)
            {
