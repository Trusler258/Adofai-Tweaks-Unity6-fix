...
public class ChartRenderingSettings
{
    ...
    /// <summary>Video bitrate in Mbps (used when rate control is vbr or cbr). 0 = auto.</summary>
    public float ChartRenderBitrateMbps = 0f;

    /// <summary>Output container format: "mp4", "mkv", "mov"</summary>
