...
namespace AdofaiTweaks.Tweaks.ChartRendering
{
    internal sealed class ChartRenderSession
    {
        ...
        private readonly ChartRenderingSettings settings;
        ...
        public ChartRenderSession(UnityModManager.ModEntry modEntry, ChartRenderingSettings settings)
        {
        ...
        public string StageText { get; private set; } = ChartRenderMain.Settings.Text("chartRendererRendering");
        ...
        public IEnumerator Run(Action<ChartRenderResult> onComplete)
        {
            ...
            StageText = ChartRenderMain.Settings.Text("chartRendererMuxing");
            DetailText = Path.GetFileName(outputPath);
            backgroundOk = false;
        ...
        private static bool Try(Action action, out Exception? failure)
        {
            ...
            {
                ChartRenderMain.Log("Chart render error: " + ex);
                failure = ex;
                return false;
            }
        }
